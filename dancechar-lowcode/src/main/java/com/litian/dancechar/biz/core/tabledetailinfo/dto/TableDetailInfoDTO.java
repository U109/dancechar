...
/**
 * 类描述: 代码生成-表关联字段信息表DTO
 *
 * @author 853523
 * @date 2021-09-22 10:30:53
 */
@Data
@ApiModel("代码生成-表关联字段信息表实例DTO")
@Builder
@AllArgsConstructor
@NoArgsConstructor
@JsonIgnoreProperties(ignoreUnknown = true)
public class TableDetailInfoDTO implements Serializable {
    ...
    @ApiModelProperty(value = "数据字典id", name = "sysDictId", required = false, example = "")
