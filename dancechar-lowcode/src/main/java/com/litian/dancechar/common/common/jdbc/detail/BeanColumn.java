...
public class BeanColumn {
    ...
    public String getBeanName() {
        if (DCStrUtil.isEmpty(beanName) && !DCStrUtil.isEmpty(jdbcName)) {
            return DCStrUtil.underLineToUpperCase(jdbcName, false);
        }
        return beanName;
    }
    ...
    public String getBeanName_() {
        if (DCStrUtil.isEmpty(beanName) && !DCStrUtil.isEmpty(jdbcName)) {
            return DCStrUtil.underLineToUpperCase(jdbcName, true);
        }
        if (!DCStrUtil.isEmpty(beanName)) {
            return DCStrUtil.firstUpperCase(beanName);
        }
        return beanName;
    }
    ...
    public String getBeanType() {
        if (DCStrUtil.isEmpty(beanType) && !DCStrUtil.isEmpty(jdbcType)) {
